...
output_dir = '/workspace/evals/evals/registry/data/biolord'

# Step 1: Customize the prompt and sample size
sample_size = 500  # You can change this number to specify how many samples you want in the sample JSONL file

# Step 2: Read the source JSON file
with open('/workspace/datasets/MedS-Bench/Explanation/task50_biolord_explanation.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
