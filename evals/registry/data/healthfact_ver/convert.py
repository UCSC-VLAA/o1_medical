...
output_dir = '/workspace/medical_bench/evals/registry/data/healthfact_ver'
...
with open('/workspace/MedS-Bench/Fact_verication/task16_test_healthfact_classification.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
