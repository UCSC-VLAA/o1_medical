...
output_dir = '/workspace/medical_bench/evals/registry/data/mimic4ed_cri'
...
with open('/workspace/MedS-Bench/Clinical_outcome_prediction/task119_mimic4ed_benchmark_critical_triage.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
