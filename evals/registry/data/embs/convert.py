...
output_dir = '/workspace/medical_bench/evals/registry/data/embs'
...
with open('/workspace/MedS-Bench/Fact_verication/task100_ebms_answer_vertification.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
