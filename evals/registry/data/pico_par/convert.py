...
output_dir = '/workspace/medical_bench/evals/registry/data/pico_par'
...
with open('/workspace/MedS-Bench/Information_extraction/task1_participant_extraction.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
