...
output_dir = '/workspace/evals/evals/registry/data/seer'
...
with open('/workspace/datasets/MedS-Bench/Treatment_planning/task131_SEER_text_classification_test.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
