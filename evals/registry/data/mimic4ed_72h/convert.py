...
output_dir = '/workspace/medical_bench/evals/registry/data/mimic4ed_hos'
...
with open('/workspace/MedS-Bench/Clinical_outcome_prediction/task118_mimic4ed_72h_ed_revisit_disposition.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
