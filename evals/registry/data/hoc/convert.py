...
output_dir = '/workspace/medical_bench/evals/registry/data/hoc'
...
with open('/workspace/MedS-Bench/Text_classification/task106_hoc_text_classification.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
