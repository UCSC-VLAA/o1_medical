...
output_dir = '/workspace/medical_bench/evals/registry/data/bc4chem'
...
with open('/workspace/MedS-Bench/NER/task125_test_bc4chem_named_enetity_recognition.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
