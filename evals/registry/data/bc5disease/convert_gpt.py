...
output_dir = '/workspace/medical_bench/evals/registry/data/bc5disease'
...
with open('/workspace/MedS-Bench/NER/task127_test_bc5disease_named_enetity_recognition.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
