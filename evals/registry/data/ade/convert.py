...
output_dir = '/workspace/evals/evals/registry/data/ade'
...
with open('/workspace/datasets/MedS-Bench/Information_extraction/task29_drug_dose_extraction.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
