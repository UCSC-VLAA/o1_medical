...
output_dir = '/workspace/medical_bench/evals/registry/data/pmc_patient'
...
with open('/workspace/MedS-Bench/Information_extraction/task74_pmc_patient_case_report_basic_information_extraction.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
for idx, instance in enumerate(few_shot_instances, 1):
    ...
    output_text = instance.get('output', '')[0].strip()
