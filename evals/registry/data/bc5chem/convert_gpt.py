...
output_dir = '/workspace/medical_bench/evals/registry/data/bc5chem'
...
with open('/workspace/MedS-Bench/NER/task126_test_bc5chem_named_enetity_recognition.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
