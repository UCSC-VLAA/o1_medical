...
output_dir = '/workspace/medical_bench/evals/registry/data/pico_out'
...
with open('/workspace/MedS-Bench/Information_extraction/task3_outcome_extraction.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
