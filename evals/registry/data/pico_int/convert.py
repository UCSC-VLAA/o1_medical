...
output_dir = '/workspace/medical_bench/evals/registry/data/pico_int'
...
with open('//workspace/MedS-Bench/Information_extraction/task2_intervention_extraction.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
