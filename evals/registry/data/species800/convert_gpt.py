...
output_dir = '/workspace/medical_bench/evals/registry/data/species800'
...
with open('/workspace/MedS-Bench/NER/task128_test_species800_named_enetity_recognition.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
