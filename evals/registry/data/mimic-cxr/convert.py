import json
import os
output_dir = '/workspace/evals/evals/registry/data/mimic-cxr'
...
with open('/workspace/datasets/MedS-Bench/Text_summarization/task112_mimic_cxr_text_summurization.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
